                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    <p>
                                      <div class="row">
                                        <div class="col-md-4">
                                          <img src="image/id size photo.jpg" width=100 height=100 alt="ID img" class="img-rounded">
                                        </div>
                                        <div class="col-md-5">
                                          <a style="color:#202020; font-family:'typo' ; font-size:18px">Pranav Pandurang Kumathekar</a>
                                        ...
                                        <h4 style="font-family:'typo' ">ADCET,Ashta</h4></div></div>
                                      </p>
                                    </div>
