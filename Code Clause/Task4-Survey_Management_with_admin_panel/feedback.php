...
<div class="col-md-10">
<a href="mailto:kumthekarpranav96@gmail.com" style="color:#000000">kumthekarpranav96@gmail.com</a><br /><br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/id size photo.jpg" width=100 height=100 alt="id pic" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="https://www.facebook.com/sunnygkp10" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Pranav Kumthekar</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">8317263212</h4>
		<h4 style="font-family:'typo' ">kumthekarpranav96@gmail.com</h4>
		<h4 style="font-family:'typo' ">ADCET</h4></div></div>
		</p>
      </div>
